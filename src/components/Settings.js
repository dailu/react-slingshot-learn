...
export default class Settings extends Component {
  ...
  async checkDatabase() {
    ...
    if (this.state.database_pass) {
      databaseEndpoint = `${databaseEndpoint}&password=${this.state.database_pass}&add_http_cors_header=1`;
    }
          ...
          <div className="pt-dialog-body">
            ...
            <Card elevation={Elevation.ONE}>
              ...
              <HotKeys keyMap={this.hotKeysMap} handlers={this.hotKeysHandlers}>
                ...
                <br />
                <InputGroup leftIcon="globe" large="true" className="pt-input-group .modifier pt-fill" type="text" placeholder="http://192.168.1.144:8123" value={this.state.database_host} onChange={this.handleChangeHost} />
                <br />
